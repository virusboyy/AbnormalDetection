    	 	...
    	 	<input type="hidden" name="flag" value="2">
			  <table width="100%" border="0" cellpadding="0" cellspacing="10" class="main_tab">
				<tr>
					...
					<table>
						<tr>
							<td class="font3 fftd">输入类型：<input type="text" name="input_type" id="input_type" size="40" /></td>
						</tr>
						<tr>
							<td class="font3 fftd">视频id：<input type="file" name="videofile" id="videofile"  size="30"/></td>
						</tr>
						<tr>
							<td class="font3 fftd">存储路径：<input type="text" name="save_path" id="save_path" size="40" /></td>
						</tr>
						<tr>
							<td class="font3 fftd">所选模型：<input type="file" name="modelfile" id="modelfile"  size="30"/></td>
						</tr>
						<tr>
							<td class="font3 fftd">播放设置：<input type="text" name="play_set" id="play_set" size="40" /></td>
						</tr>
