	...
	<div class="page-lock">
		<div class="page-logo" style="margin-bottom: 2px">
			<a class="brand" href="login.html"
				style="font-size: 22px; color: #FFF;">行人异常行为检测<font color="#FFCC00">AD</font><span
		...
		<form action="login" method="post" id="loginForm">
			...
			<div class="page-footer" style="color: #fff">
				兼容浏览器IE8+，最佳分辨率1280*800. <br>2019 @ 725实验室  http://sist.lnu.edu.cn/
			</div>
		</form>
	</div>
